...
public class Categoria {
    ...
    //Ser llamado solo desde cacheable
    public List<Posicion> getRankingGlobal(Competicion competicion, DescalificacionRepository descalificacionRepository, ClasificadoRepository clasificadoRepository) {
